import { pgTable, foreignKey, unique, pgEnum, uuid, timestamp, text, primaryKey } from "drizzle-orm/pg-core"
...
(table) => {
	return {
		tweetHashtagPkey: primaryKey({ columns: [table.tweetId, table.hashtagId], name: "tweet_hashtag_pkey"})
	}
});